...
// Info
/*static void imprimir_info_modelo(Modelo *f)
{
    if (f == NULL)
    {
...
static void cargar_modelo(Modelo **modelo_actual, Uint64 *ultimo_clic, const Uint64 COOLDOWN_BOTON, Arena *arena)
{
...
static void pintar_modelo(Modelo *f, SDL_Renderer *renderer, float angulo, float distancia_camara, int ventana_ancho, int ventana_alto, float escala)
{
    if (f == NULL)
        return;
