...
static void proyectar_a_pixel(float x, float y, float z, float escala_x, float escala_y, float *px, float *py, int area_ancho, int area_alto, int offset_x, int offset_y)
{
